...
const db = require(`../${DATABASE}`);// eslint-disable-line import/no-dynamic-require
...
const searchRestaurants = (keyword, latitudeAtStart, longitudeAtStart) => {
  const filterNearRestaurantsFromNameDescAndTags = (restaurant) => {
    ...
    const distance = haversine.distanceBetweenLocations(
      latitudeAtStart, longitudeAtStart, restaurantLatitude, restaurantLongitude,
    );
